...
// 🌟 全遊戲的道具圖鑑總表（已為消耗品與部分裝備/特產配置對應素質影響）
export const ITEM_DATABASE: Record<string, ItemDefinition> = {
    ...
    // === 咖啡與茶飲類 (消耗品) ===
    'item_1': { 
        id: 'item_1', name: '香濃熱咖啡', category: 'consumable', icon: '☕', desc: '咖啡館特製的熱咖啡，飲用後可恢復些許精神，帶來溫暖。', rarity: 'common',
        effect: { energy: 20 } 
    },
    'item_2': { 
        id: 'item_2', name: '洋甘菊舒壓茶', category: 'consumable', icon: '🍵', desc: '帶有淡淡花香的草本茶，能撫平焦慮與疲憊的心靈。', rarity: 'common',
        effect: { resilience: 5, energy: 10 } 
    },
    'item_3': { 
        id: 'item_3', name: '冰釀蜂蜜檸檬', category: 'consumable', icon: '🍋', desc: '酸甜清涼的消暑良伴，在炎熱午後帶來一抹清爽。', rarity: 'common',
        effect: { energy: 15 } 
    },
    'item_4': { 
        id: 'item_4', name: '黑糖薑母茶', category: 'consumable', icon: '🫚', desc: '微辣帶甜的暖心熱飲，驅散雨天帶來的潮濕寒意。', rarity: 'common',
        effect: { resilience: 4, energy: 15 } 
    },
    'item_5': { 
        id: 'item_5', name: '職人手沖拿鐵', category: 'consumable', icon: '🥛', desc: '綿密奶泡與濃郁咖啡交織的完美比例，充滿幸福感。', rarity: 'rare',
        effect: { energy: 25, resilience: 2 } 
    },
    'item_6': { 
        id: 'item_6', name: '特調星空可可', category: 'consumable', icon: '🍫', desc: '撒上食用金箔的濃郁熱可可，夜晚喝了能做個好夢。', rarity: 'rare',
        effect: { resilience: 8, energy: 10 } 
    },
    'item_7': { 
        id: 'item_7', name: '薄荷冰沙', category: 'consumable', icon: '🌿', desc: '瞬間提神醒腦的清涼冰品，夏天不可或缺的良藥。', rarity: 'common',
        effect: { energy: 20 } 
    },
    'item_8': { 
        id: 'item_8', name: '桂圓紅棗茶', category: 'consumable', icon: '🥣', desc: '傳統滋補的甜湯，滋潤喉嚨也溫暖心房。', rarity: 'common',
        effect: { resilience: 6, energy: 10 } 
    },

    // === 甜點與輕食類 (消耗品) ===
    'item_9': { 
        id: 'item_9', name: '法式經典可頌', category: 'consumable', icon: '🥐', desc: '外皮酥脆、奶油香氣四溢的晨光早餐首選。', rarity: 'common',
        effect: { energy: 15 } 
    },
    'item_10': { 
        id: 'item_10', name: '手工草莓大福', category: 'consumable', icon: '🍓', desc: 'Q彈麻糬包覆著多汁草莓與綿密紅豆泥，酸甜適中。', rarity: 'common',
        effect: { resilience: 3, energy: 10 } 
    },
    'item_11': { 
        id: 'item_11', name: '抹茶紅豆戚風', category: 'consumable', icon: '🍰', desc: '茶香濃郁而不苦澀的日式風味蛋糕。', rarity: 'rare',
        effect: { resilience: 5, energy: 10 } 
    },
    'item_12': { 
        id: 'item_12', name: '奶油肉桂捲', category: 'consumable', icon: '🥨', desc: '出爐時香氣撲鼻，療癒力滿點的罪惡美味。', rarity: 'common',
        effect: { resilience: 4, energy: 15 } 
    },
    'item_13': { 
        id: 'item_13', name: '蜂蜜鬆餅', category: 'consumable', icon: '🥞', desc: '淋滿琥珀色天然蜂蜜的金黃鬆餅。', rarity: 'common',
        effect: { energy: 20 } 
    },
    'item_14': { 
        id: 'item_14', name: '手工黑巧餅乾', category: 'consumable', icon: '🍪', desc: '酥脆扎實的巧克力餅乾，適合配茶享用。', rarity: 'common',
        effect: { energy: 10 } 
    },
    'item_15': { 
        id: 'item_15', name: '暖心蘋果派', category: 'consumable', icon: '🥧', desc: '帶有肉桂香氣的熱烤蘋果內餡，家的味道。', rarity: 'rare',
        effect: { resilience: 6, energy: 15 } 
    },
    'item_16': { 
        id: 'item_16', name: '彩虹馬卡龍', category: 'consumable', icon: '🍬', desc: '精緻甜美的法式小點心，看了心情就會變好。', rarity: 'epic',
        effect: { resilience: 10, perception: 2 } 
    },

    // === 隨身心情與日常物品 (消耗品/材料) ===
    'item_17': { 
        id: 'item_17', name: '空白心情筆記本', category: 'consumable', icon: '📓', desc: '用來記錄每日呢喃與靈感的乾淨筆記本。', rarity: 'common',
        effect: { perception: 3 } 
    },
    'item_18': { 
        id: 'item_18', name: '彩色鋼筆墨水', category: 'consumable', icon: '🖋️', desc: '深藍色的沉穩墨水，適合寫下真摯的文字。', rarity: 'common',
        effect: { perception: 2 } 
    },
    'item_19': { 
        id: 'item_19', name: '暖光隨身香氛蠟燭', category: 'consumable', icon: '🕯️', desc: '散發淡淡薰衣草香，點燃後能沉澱雜亂的思緒。', rarity: 'rare',
        effect: { resilience: 8 } 
    },
    'item_20': { 
        id: 'item_20', name: '復古底片相機', category: 'consumable', icon: '📷', desc: '記錄小鎮日常與美好瞬間的機械式相機。', rarity: 'rare',
        effect: { perception: 6 } 
    },
    'item_21': { 
        id: 'item_21', name: '晴天娃娃', category: 'consumable', icon: '🏮', desc: '掛在窗前祈求明天也是個好天氣的手作吊飾。', rarity: 'common',
        effect: { resilience: 4 } 
    },
    'item_22': { 
        id: 'item_22', name: '音樂盒', category: 'consumable', icon: '🎶', desc: '轉動發條就會流瀉出清脆悠揚旋律的古董音樂盒。', rarity: 'epic',
        effect: { resilience: 12, perception: 4 } 
    },
    'item_23': { 
        id: 'item_23', name: '暖暖包', category: 'consumable', icon: '🔥', desc: '寒冬或雨天時握在手中瞬間暖和的隨身法寶。', rarity: 'common',
        effect: { energy: 10, resilience: 2 } 
    },
    'item_24': { 
        id: 'item_24', name: '薄荷精油滾珠', category: 'consumable', icon: '💧', desc: '感到疲憊時塗抹在太陽穴，能瞬間清爽。', rarity: 'common',
        effect: { energy: 15 } 
    },

    // === 自然與探索材料 (材料 - 主要是收集，不直接當作消耗使用，但保留基礎定義) ===
    ...
    'item_39': { 
        id: 'item_39', name: '萬聖南瓜糖', category: 'consumable', icon: '🍬', desc: '帶有肉桂與南瓜風味的搞怪糖果。', rarity: 'common',
        effect: { energy: 10 } 
    },
    'item_40': { 
        id: 'item_40', name: '平安夜薑餅人', category: 'consumable', icon: '🍪', desc: '聖誕節限定的手工薑餅，造型十分可愛。', rarity: 'rare',
        effect: { resilience: 5, energy: 10 } 
    },
    ...
    'item_50': { 
        id: 'item_50', name: '太陽光芒結晶', category: 'material', icon: '☀️', desc: '象徵「Where Daylight Pauses」精神的溫暖核心結晶。', rarity: 'epic',
        effect: { resilience: 20, perception: 10, energy: 50 } 
    }
};